...
const DashBoard = async () => {
  ...
  return (
    <>
      <div className="py-4 px-4 relative flex flex-col gap-10 overflow-hidden lg:gap-2 lg:flex-row lg:w-[95%] lg:h-[90vh] bg-neutral-900/80  text-white lg:rounded-md lg:shadow-md shadow-purple-800/20">
